...
import { Position, TradeHistory, TradingState, PendingOrder } from '@/lib/tracker/types';
...
export class TradingEngine {
  ...
  openPosition(symbol: string, side: 'long' | 'short', leverage: number, amount: number, price: number, tp?: number, sl?: number, isLimit: boolean = false, reason?: string) {
