  ...
  return (
    <header className="h-14 border-bottom border-zinc-800 bg-zinc-950 flex items-center justify-between px-6 shrink-0">
      <div className="flex items-center gap-6">
        ...
        <Select value={symbol} onValueChange={(val: string | null) => { if (val) onSymbolChange(val); }}>
        ...
        <Select value={interval} onValueChange={(val: string | null) => { if (val) onIntervalChange(val); }}>
